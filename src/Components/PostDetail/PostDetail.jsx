        ...
        <div>
            <div className="w-10/12 mx-auto my-10">
                <div className="relative">
                    <img src={picture} alt="" className=" w-full md:h-screen object-cover rounded-lg" />
                    <div className="absolute w-full py-3 md:py-6 bg-black bottom-0 rounded-b-lg bg-opacity-40">
